...
deb: all
	...
	cat > deb-packages/myrpc-client/DEBIAN/control << 'EOFCTRL'
...
EOFCTRL
	...
	cat > deb-packages/myrpc-server/DEBIAN/control << 'EOFCTRL'
...
EOFCTRL
	cat > deb-packages/myrpc-server/DEBIAN/postinst << 'EOFCTRL'
#!/bin/bash
